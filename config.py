...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8251372979:AAGbTtZbOP_E-ao-LLJUrKQrbGirdbOrYcY")
...
FILE_AUTO_DELETE = int(os.getenv("FILE_AUTO_DELETE", "2600")) # auto delete in seconds
